...
// import { ADD_STUDENT_SUCCESS, FETCH_COURSES_REQUEST, FETCH_STUDENTS_REQUEST,FETCH_TEACHERS_REQUEST,EDIT_STUDENT_REQUEST, ADD_STUDENT_REQUEST, DELETE_STUDENT_REQUEST, EDIT_STUDENT_SUCCESS, DELETE_STUDENT_SUCCESS, EDIT_COURSE_REQUEST, DELETE_COURSE_SUCCESS, DELETE_COURSE_REQUEST } from "./dashboardd/actions";
...
//     try {
//       dispatch({
//         type: FETCH_TEACHERS_SUCCESS, payload: response.data.teachers
...
//     try {
//        dispatch({
//         type: FETCH_COURSES_SUCCESS, payload: response.data 
//        }) ;
//       setCourses(response.data); // Assuming the API returns an array of courses
//     } catch (error) {
//       console.error("Error fetching courses:", error);
...
//      dispatch({
//       type: ADD_STUDENT_SUCCESS, payload: response.data.newStudent
//      });
//       setStudents([...students, response.data]);
//       handleCloseStudentDialog();
//    // } catch (error) {
...
//     try {
//      dispatch({
//       type: EDIT_STUDENT_SUCCESS, payload: response.data
//      });
//       // setStudents(
//       //   students.map((student) =>
...
//       dispatch(
//         type: DELETE_STUDENT_SUCCESS, payload: action.payload
//       );
//       setStudents(
...
//   //     dispatch({
//   //       type: ADD_COURSE_SUCCESS, payload: response.data
//   //     })
//   //     //setCourses([...courses, response.data]);
...
//     // Dispatch the action to add a course, handled by saga
//     dispatch({
...
//   //   dispatch({
//   //     type: EDIT_COURSE_SUCCESS, payload: response.data
//   //   })
//   //     setCourses(
//   //       courses.map((course) =>
...
//   const handleEditCourse = async () => {
//   if (!currentCourse || !currentCourse.id || !currentCourse.name) return;

//   try {
//     // Dispatch the action to trigger the saga that will handle the API call
//     dispatch({
//       type: 'EDIT_COURSE_REQUEST',
//       payload: currentCourse,  // Passing currentCourse with all required fields
//     });

//     // Close the dialog after initiating the dispatch
//     handleCloseCourseDialog();
//   } catch (error) {
//     console.error('Error editing course:', error);
//   }
...
//         type: DELETE_COURSE_SUCCESS, payload: action.payload
//       );
//       setCourses(courses.filter((course) => course.id !== courseToDelete.id));
//     } 
...
// export default Dashboard;
// function dispatch(arg0: { type: string; payload: any; }, DELETE_COURSE_SUCCESS: string, payload: any, payload: any) {
